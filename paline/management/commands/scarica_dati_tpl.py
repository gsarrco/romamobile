...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		print "\n\n1 di 5: Download rete"
		scarica_rete()
		print "\n\n2 di 5: Aggiornamento rete nel database"
		carica_rete()
		print "\n\n3 di 5: Download orari partenza"
		scarica_orari_partenza()
		print "\n\n4 di 5: Ricalcolo frequenze da timetable"
		calcola_frequenze()
		print "\n\n5 di 5: Download statistiche passaggi"
