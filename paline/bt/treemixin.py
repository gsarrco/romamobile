...
class TreeMixin(object):
	...
	* fromkeys(S[,v]) -> New tree with keys from S and values equal to v.
	...
	def lte_key(self, key):
		"""
		Get (k,v) pair of such that k is the max less than or equal to key
		"""
		node = self.root
		found = None
		while node is not None:
	...
	def lt_key(self, key):
		"""
		Get (k,v) pair of such that k is the max less than key
		"""
		node = self.root
		found = None
		while node is not None:
	...
	def gte_key(self, key):
		"""
		Get (k,v) pair of such that k is the min greater than or equal to key
		"""
		node = self.root
		found = None
		while node is not None:
